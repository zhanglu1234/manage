		...
		<el-dialog title="添加申请" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
			...
			<el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="80px">
                ...
                <el-form-item label="入/出园" prop="driverapplytype" >
				 <el-select v-model="addForm.driverapplytype" style="width:449px;">
                            <el-option label="出园" value="1"></el-option>
                            <el-option label="入园" value="2"></el-option>
                </el-select>
				</el-form-item>
				<el-form-item label="车型" prop="drivercartype" >
					 <el-select v-model="addForm.drivercartype" style="width: 449px;">
                            <el-option label="卡车" value="1"></el-option>
                            <el-option label="货车" value="2"></el-option>
                            <el-option label="汽车" value="5"></el-option>
                </el-select>
				</el-form-item>
				<el-form-item label="预约日期" prop="applytime" >
					 <el-date-picker v-model="addForm.applytime" type="date" placeholder="选择日期">
                     </el-date-picker>
                     <el-select v-model="addForm.contracttime"  placeholder="请选择时段" style="width: 229px;">
