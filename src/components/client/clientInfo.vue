<template>
	<div>
		...
		<el-breadcrumb separator-class="el-icon-arrow-left">
			...
			<el-breadcrumb-item :to="{ path: '/client' }">客户列表</a>
			</el-breadcrumb-item>
		...
		<el-dialog title="添加客户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
			...
			<el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="80px">
				...
				<el-form-item label="客户账号" prop="clientuniqueid">
					<el-input v-model="addForm.clientuniqueid"></el-input>
				</el-form-item>
				<el-form-item label="客户密码" prop="clientpassword">
					<el-input v-model="addForm.clientpassword"></el-input>
				</el-form-item>
        ...
        <el-form-item label="客户姓名" prop="clientname" >
				...
				<el-form-item label="客户密码" prop="clientpassword">
					<el-input v-model="editForm.clientpassword"></el-input>
				</el-form-item>
				<el-form-item label="手机号码" prop="clientphone">
					<el-input v-model="editForm.clientphone"></el-input>
				</el-form-item>
        <el-form-item label="错误次数" prop="clientloginerror">
					<el-input v-model="editForm.clientloginerror"></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    async getClientList() {
      await this.$http
        .post("/clientInfo/findAllClientInfo", this.queryInfo, {
          headers: {
